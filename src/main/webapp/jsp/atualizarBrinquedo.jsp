<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<body style="background-color: var(--third);">
		...
		<h1 style="color: var(--complement1);" class="text-2xl font-semibold text-center mb-6 mt-6">Editar Brinquedos
		</h1>
		...
		<form action="ServletBrinquedo?cmd=atualizar" method="post" enctype="multipart/form-data"
			...
			<div class="mb-4 grid grid-cols-2 gap-4">
				<div class="flex items-center">
					<div class="">
						<label style="color: var(--fourth);" for="codigo"
							class="block text-sm font-semibold mb-2">Código (8 números)</label>
				...
				<div>
					<label style="color: var(--fourth);" for="nome"
						class="block text-sm font-semibold mb-2">Nome</label>
			...
			<div class="mb-4">
				<label style="color: var(--fourth);" for="image" class="block font-semibold text-gray-800 ">Imagem
					Atual</label> <img src="<%=brinquedo.getImage()%>" alt="Imagem Atual" class=" w-40 h-40 mb-2">
			</div>
			<input type="hidden" name="imagemAtual" value="<%=brinquedo.getImage()%>">
			<div class="mb-4 rounded-lg">
				<label style="color: var(--fourth);" for="image"
					class="block text-sm font-semibold text-gray-600 mb-2">Nova imagem</label>
				<div style="color: var(--fourth);" id="dropzone"
					...
					<svg width="30" height="30" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							...
							stroke="#F440C7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
					</svg>
			...
			<div class="gap-8 flex flex-col">
				<button type="submit" value="Enviar" class="text-white py-2 px-4 rounded-full buttons w-full">Editar
					Brinquedo</button>
				<a href="jsp/admin.jsp#listagem" class=" text-center w-full text-white links rounded-lg">Voltar à
					administração</a>
			</div>
		</form>
