			...
			<%@ page import="java.util.List" %>
				<%@ page import="br.edu.exemplo.dao.BrinquedoDAO" %>
					...
					<head>
						...
						<title>Sobre nós | Toylandia</title>
						...
						<nav style="background-color: var(--complement1);"
							...
							<div>
								<ul class="flex space-x-6">
									...
									<li><a href="../jsp/team.jsp" class="nav-link font-semibold links">Sobre nós</a>
									</li>
								</ul>
							</div>
							<div>
						...
						<section style="background-color: var(--third);" class="py-8">
							<div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
								<div class="w-full md:w-1/2 md:pr-4">
									<img src="../imgs/pessoas.png" alt="Toylandia"
										class="mx-auto md:mx-0 max-w-xs md:max-w-full">
								</div>

								<div class="w-full md:w-1/2 text-center md:text-left">
									<h2 class="text-3xl font-bold text-white mb-4">Sobre Nós</h2>
									<p class="text-white leading-relaxed text-md">
										Toylandia é muito mais do que apenas um catálogo de presentes; somos apaixonados
										curadores de momentos felizes. Fundada por entusiastas de brinquedos e amantes
										de presentes, nossa missão é proporcionar alegria e felicidade a pessoas de
										todas as idades. Com anos de experiência e uma paixão compartilhada pela magia
										dos presentes, nossa equipe cuidadosamente seleciona e apresenta os produtos
										mais encantadores e únicos que você encontrará.
									</p>
								</div>
							</div>
						</section>
					...
					<!--Foto time-->
						<div style="color: var(--third);" class="mt-10 text-2xl font-semibold text-center mb-10">Nossa
							Equipe</div>

						<div class="py-2 flex gap-20 justify-center  items-center">
							<!--Eduador-->
							<div class=" flex flex-col justify-center align-center items-center">
								<img src="../imgs/carlos@toylandia" alt="carlos" class="w-40 h-40">
								<div class=" flex flex-col align-center items-center py-4">
									<p style="color: var(--fourth);" class="text-sm font-bold">Carlos Eduardo </p>
									<p style="color: var(--fourth);" class="">29936489</p>
								</div>

								<div class="flex gap-4 justify-center align-center items-center">
									<a href=" https://github.com/cadunands" target="_blank"
										class="group hover:text-green-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
											viewBox="0 0 40 40" fill="none">
											<path
												d="M20.0001 0C8.95506 0 6.10352e-05 9.09522 6.10352e-05 20.3132C6.10352e-05 29.8316 6.45339 37.796 15.1534 40C15.0601 39.7258 15.0001 39.4075 15.0001 39.0131V35.5413C14.1884 35.5413 12.8284 35.5413 12.4867 35.5413C11.1184 35.5413 9.90173 34.9437 9.31173 33.8333C8.65673 32.5992 8.54339 30.7118 6.92006 29.5573C6.43839 29.1731 6.80506 28.7347 7.36006 28.7939C8.38506 29.0884 9.23506 29.8028 10.0351 30.8625C10.8317 31.9238 11.2067 32.1642 12.6951 32.1642C13.4167 32.1642 14.4967 32.1219 15.5134 31.9594C16.0601 30.5493 17.0051 29.2510 18.1601 28.6382C11.5001 27.9424 8.32173 24.5772 8.32173 20.0085C8.32173 18.0415 9.14673 16.1388 10.5484 14.5358C10.0884 12.9446 9.51006 9.69953 10.7251 8.46382C13.7217 8.46382 15.5334 10.4376 15.9684 10.9708C17.4617 10.4511 19.1017 10.1566 20.8251 10.1566C22.5517 10.1566 24.1984 10.4511 25.6951 10.9742C26.1251 10.4444 27.9384 8.46382 30.9417 8.46382C32.1617 9.70123 31.5767 12.9598 31.1117 14.5476C32.5051 16.1473 33.3251 18.0449 33.3251 20.0085C33.3251 24.5738 30.1517 27.9374 23.5017 28.6365C25.3317 29.6064 26.6667 32.3318 26.6667 34.3851V39.0131C26.6667 39.1892 26.6284 39.3161 26.6084 39.4668C34.4017 36.6923 40.0001 29.1765 40.0001 20.3132C40.0001 9.09522 31.0451 0 20.0001 0Z"
												fill="#F440C7" />
										</svg>
									</a>

									<a href=" https://www.linkedin.com/in/eduardo-fernandes-1001/" target="_blank"
										class="group hover:text-red-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37"
											viewBox="0 0 47 47" fill="none">
											<path
												d="M39.2381 4H8.7619C6.13333 4 4 6.13333 4 8.7619V39.2381C4 41.8667 6.13333 44 8.7619 44H39.2381C41.8667 44 44 41.8667 44 39.2381V8.7619C44 6.13333 41.8667 4 39.2381 4ZM16.381 19.2381V37.3333H10.6667V19.2381H16.381ZM10.6667 13.9714C10.6667 12.6381 11.8095 11.619 13.5238 11.619C15.2381 11.619 16.3143 12.6381 16.381 13.9714C16.381 15.3048 15.3143 16.381 13.5238 16.381C11.8095 16.381 10.6667 15.3048 10.6667 13.9714ZM37.3333 37.3333H31.619C31.619 37.3333 31.619 28.5143 31.619 27.8095C31.619 25.9048 30.6667 24 28.2857 23.9619H28.2095C25.9048 23.9619 24.9524 25.9238 24.9524 27.8095C24.9524 28.6762 24.9524 37.3333 24.9524 37.3333H19.2381V19.2381H24.9524V21.6762C24.9524 21.6762 26.7905 19.2381 30.4857 19.2381C34.2667 19.2381 37.3333 21.8381 37.3333 27.1048V37.3333Z"
												fill="#F440C7" />
										</svg>
									</a>
								</div>
							...
							<!--Felipe-->
							<div class=" flex flex-col justify-center align-center items-center">
								<img src="../imgs/felipe@toylandia" alt="Felipe" class="w-40 h-40">
								<div class=" flex flex-col align-center items-center py-4">
									<p style="color: var(--fourth);" class="text-sm font-bold">Felipe Pires </p>
									<p style="color: var(--fourth);" class="">29957478</p>
								</div>

								<div class="flex gap-4 justify-center align-center items-center">
									<a href="https://github.com/FelPires" target="_blank"
										class="group hover:text-green-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
											viewBox="0 0 40 40" fill="none">
											<path
									...
									<a href="https://www.linkedin.com/in/felipepiresalves" target="_blank"
										class="group hover:text-red-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37"
											viewBox="0 0 47 47" fill="none">
											<path
							...
							<!--Matheus-->
							<div class="flex flex-col justify-center align-center items-center">
								<img src="../imgs/matheus@toylandia" alt="Matheus" class="w-40 h-40">
								<div class=" flex flex-col align-center items-center py-4">
									<p style="color: var(--fourth);" class="text-sm font-bold">Matheus Banqueiro</p>
									<p style="color: var(--fourth);" class="">29960231</p>
								</div>

								<div class="flex gap-4 justify-center align-center items-center">
									<a href="https://github.com/matheusbanqueiro" target="_blank"
										class="group hover:text-green-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
											viewBox="0 0 40 40" fill="none">
											<path
						...
						<div class="py-10 flex gap-20 justify-center  items-center">

							<!--Renan-->
							<div class=" flex flex-col justify-center align-center items-center">
								<img src="../imgs/renan@toylandia" alt="Renan" class="w-40 h-40">
								<div class=" flex flex-col align-center items-center py-4">
									<p style="color: var(--fourth);" class="text-sm font-bold">Renan Miguel </p>
									<p style="color: var(--fourth);" class="">29316561</p>
								</div>

								<div class="flex gap-4 justify-center align-center items-center">
									<a href="https://github.com/RCajui" target="_blank"
										class="group hover:text-green-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
											viewBox="0 0 40 40" fill="none">
											<path
									...
									<a href="https://www.linkedin.com/in/renancajui" target="_blank"
										class="group hover:text-red-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37"
											viewBox="0 0 47 47" fill="none">
											<path
							...
							<!--Rodrigo-->
							<div class="flex flex-col justify-center align-center items-center">
								<img src="../imgs/rodrigo@toylandia" alt="Rodrigo" class="w-40  h-40">
								<div class=" flex flex-col align-center items-center py-4">
									<p style="color: var(--fourth);" class="text-sm font-bold">Rodrigo Fernandes </p>
									<p style="color: var(--fourth);" class="">29760119</p>
								</div>

								<div class="flex gap-4 justify-center align-center items-center">
									<a href="https://github.com/orodyys" target="_blank"
										class="group hover:text-green-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
											viewBox="0 0 40 40" fill="none">
											<path
									...
									<a href="https://br.linkedin.com/in/rodrigo-fernandes-da-silva-57a170236"
										target="_blank" class="group hover:text-red-500">
										<svg xmlns="http://www.w3.org/2000/svg" width="37" height="37"
											viewBox="0 0 47 47" fill="none">
											<path
												d="M39.2381 4H8.7619C6.13333 4 4 6.13333 4 8.7619V39.2381C4 41.8667 6.13333 44 8.7619 44H39.2381C41.8667 44 44 41.8667 44 39.2381V8.7619C44 6.13333 41.8667 4 39.2381 4ZM16.381 19.2381V37.3333H10.6667V19.2381H16.381ZM10.6667 13.9714C10.6667 12.6381 11.8095 11.619 13.5238 11.619C15.2381 11.619 16.3143 12.6381 16.381 13.9714C16.381 15.3048 15.3143 16.381 13.5238 16.381C11.8095 16.381 10.6667 15.3048 10.6667 13.9714ZM37.3333 37.3333H31.619C31.619 37.3333 31.619 28.5143 31.619 27.8095C31.619 25.9048 30.6667 24 28.2857 23.9619H28.2095C25.9048 23.9619 24.9524 25.9238 24.9524 27.8095C24.9524 28.6762 24.9524 37.3333 24.9524 37.3333H19.2381V19.2381H24.9524V21.6762C24.9524 21.6762 26.7905 19.2381 30.4857 19.2381C34.2667 19.2381 37.3333 21.8381 37.3333 27.1048V37.3333Z"
						...
						<footer class=" flex-col" style="background-color: var(--third);">
