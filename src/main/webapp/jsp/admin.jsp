        ...
        <%@ page import="java.util.List" %>
            <%@ page import="br.edu.exemplo.dao.BrinquedoDAO" %>
                <%@ page import="java.util.Map" %>
                    ...
                    <body style="background-color: var(--complement1);" class="flex flex-col min-h-screen">
                        <jsp:useBean id="admin" scope="session" class="br.edu.exemplo.model.Admin" />
                        ...
                        <nav style="color: var(--third);" class="p-0">
                            <div style="color: var(--third);" class="flex items-center justify-between p-3">
                                ...
                                <div class="flex items-center space-x-4">
                                    <svg class="cursor-pointer" id="menuIcon" width="22" height="24" viewBox="0 0 14 16"
                                        ...
                                        <path
                                            ...
                                            fill="#510087" />
                                        <path
                                            d="M7 4C5.89543 4 5 3.10457 5 2C5 0.89543 5.89543 -4.82823e-08 7 0C8.10457 4.82823e-08 9 0.895431 9 2C9 3.10457 8.10457 4 7 4Z"
                                            fill="#510087" />
                                        <path
                                            d="M7 10C5.89543 10 5 9.10457 5 8C5 6.89543 5.89543 6 7 6C8.10457 6 9 6.89543 9 8C9 9.10457 8.10457 10 7 10Z"
                                            fill="#510087" />
                                        <path
                                            d="M7 16C5.89543 16 5 15.1046 5 14C5 12.8954 5.89543 12 7 12C8.10457 12 9 12.8954 9 14C9 15.1046 8.10457 16 7 16Z"
                                            fill="#510087" />
                                        <path
                                            d="M12 4C10.8954 4 10 3.10457 10 2C10 0.89543 10.8954 -4.82823e-08 12 0C13.1046 4.82823e-08 14 0.895431 14 2C14 3.10457 13.1046 4 12 4Z"
                                            fill="#510087" />
                                        <path
                                            d="M12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8C14 9.10457 13.1046 10 12 10Z"
                                            fill="#510087" />
                                        <path
                                    ...
                                    <img src="../imgs/<%= admin.getLogin() %>" alt="Foto do perfil"
                                ...
                                <div class="z-50 hidden absolute right-20 top-14 mt-2" id="menuDropdown">
                                    <div class="bg-gray-100 rounded-lg shadow-md p-4 text-center">
                                        <div class="mb-4 gap-4 grid grid-cols-2">
                                            <a style="color: var(--third);" href="#dashboard"
                                                class="transition-transform transform hover:translate-y-1  text-sm flex flex-col items-center "
                                                onclick="mostrarGraficos()" aria-current="page">
                                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    class="w-6 h-6 mb-2">
                                                    <path
                                                        d="M9 1.05493C4.50005 1.55238 1 5.36745 1 10C1 14.9706 5.02944 19 10 19C14.6326 19 18.4476 15.5 18.9451 11H9V1.05493Z"
                                                        stroke="#510087" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M18.4878 7H13V1.5123C15.5572 2.41613 17.5839 4.44285 18.4878 7Z"
                                                        stroke="#510087" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                                Dashboard
                                            ...
                                            <a style="color: var(--third);" href="#listagem" id="mostrarListagem"
                                                class="transition-transform transform hover:translate-y-1  text-sm flex flex-col items-center "
                                                onclick="mostrarListagem()">
                                                <svg viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    class="w-6 h-6 mb-2">
                                                    <path d="M1 1H17M1 5H17M1 9H17M1 13H17" stroke="#510087"
                                        ...
                                        <div class="gap-4 grid grid-cols-2">
                                            <a style="color: var(--third);" href="#mostrarAdicionar"
                                                class="transition-transform transform hover:translate-y-1 text-sm flex flex-col items-center"
                                                onclick="mostrarAdicionar()">
                                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    class="w-6 h-6 mb-2">
                                                    <path
                                            ...
                                            <a href="../index.jsp"
                                                class="transition-transform transform hover:translate-y-1  text-sm flex flex-col items-center text-sm flex flex-col items-center text-gray-700 text-red-600 hover:text-red-700">
                                                <svg width="20" height="18" viewBox="0 0 20 18" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mb-2">
                                                    <path
                        ...
                        <% } else { %>
                            <div class="flex justify-center items-center ">
                                <div style="border: 0.2px solid var(--third);"
                                    ...
                                    <p style="color: var(--fourth);" class="mt-10 font-semibold">Não Temos informações
                                        completas para a exibição do gráfico.</p>
                            ...
                            <% } %>
                                ...
                                <!-- ... Modal Cancelamento  ... -->
                                <div id="myModal"
                                    class="z-50 hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                    <div style="background-color: var(--complement1);"
                                        class="modal-content flex flex-col items-center justify-center relative transform overflow-hidden rounded-lg bg-white text-center shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                        <div class="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                            <div
                                                class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:h-10 sm:w-10">
                                        ...
                                        <div class="border bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                            <button type="button" id="confirmDeleteButton"
                                                class="w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-700 sm:ml-3 sm:w-auto transition-transform transform hover:translate-y-1">Confirmar</button>
                                            <button type="button" onclick="fecharModalExclusao()"
                                                class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto transition-transform transform hover:translate-y-1">Cancelar</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- ... Listagem Brinquedos  ... -->
                                ...
                                <div class="p-10 hidden table-container" id="listagemTable">
                                    ...
                                    <div class="py-4 flex flex-col items-center justify-center">
                                        <div class="relative mb-4 items-center justify-center">
                                            <input style="background-color: var(--complement1); color: var(--fifth);"
                                                onkeyup="filtrarBrinquedos()" type="text" id="txtPesquisa"
                                    ...
                                    <table id="tabelaBrinquedos" class="w-full min-w-full divide-y divide-gray-200">
                                        <thead style="color: var(--complement1)">
                                            <tr style="background-color: var(--fourth)">
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">Image
                                                </th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">
                                                    Código</th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">Nome
                                                </th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold  uppercase ">
                                                    Categoria</th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">Marca
                                                </th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">Valor
                                                </th>
                                                <th scope="col"
                                                    class="px-6 py-3 text-center text-xs font-semibold uppercase ">Ações
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody style="background-color: var(--complement1); color: var(--fourth)">
                                            <% BrinquedoDAO dao=new BrinquedoDAO(); List<Brinquedo> brinquedosList =
                                                dao.listarTodos();
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        <img src="<%=brinquedo.getImage()%>" alt="Brinquedo"
                                                            class="h-12 w-12 mx-auto rounded-sm">
                                                    </td>
                                                    ...
                                                    <td class="px-2 py-4 text-center whitespace-nowrap">
                                                        <div class="justify-center text-center flex">
                                                            ...
                                                            <a href="../ServletBrinquedo?cmd=con2&codigo=<%=brinquedo.getCodigo()%>"
                                                                class="py-2 px-4 text-pink-600 cursor-pointer rounded-lg flex items-center justify-center transition-transform transform hover:translate-y-1"
                                                                title="Ver Brinquedo">
                                ...
                                <div class="hidden mt-10 mb-10" id="adicionarForms">
                                    <form action="../ServletBrinquedo?cmd=incluir" method="post"
                                        enctype="multipart/form-data"
                                        class="bg-white p-4 rounded-lg shadow-md max-w-lg mx-auto">
                                        <input type="hidden" name="cmd" value="incluir">

                                        <div class="mb-4 grid grid-cols-2 gap-4">
                                            <div class="flex items-center">
                                                <div class="">
                                                    <label style="color: var(--fourth);" for="codigo"
                                                        class="block text-sm font-semibold mb-2">Código (8 números)
                                                        <span class="text-red-400">*</span></label>


                                                    <input style="color: var(--fifth);" type="text" id="codigo"
                                            ...
                                            <div>
                                                <label style="color: var(--fourth);" for="nome"
                                                    class="block text-sm font-semibold mb-2">Nome <span
                                                        class="text-red-400">*</span></label>
                                                <input style="color: var(--fifth);" type="text" id="nome" name="nome"
                                                    required
                                        ...
                                        <div class="flex mb-4 gap-4">
                                            <div class="w-full ">
                                                <label style="color: var(--fourth);" for="categoria"
                                                    class="block text-sm font-semibold text-gray-600 mb-2">Categoria
</label>
                                                <% BrinquedoDAO daoCategoria=new BrinquedoDAO(); List<String> categorias
                                                    = daoCategoria.listarCategorias();
                                                    %>
                                                    <select id="categoria" name="categoria" required
                                                        style="color: var(--fifth);"
                                                        class="bg-white w-full px-3 py-2 border rounded-lg border-purple-600 focus:outline-none focus:border-yellow-500">
                                                        <option style="color: var(--fifth);" value="jogos">Jogos
                                                        </option>
                                                    ...
                                                    <a id="mostrarInput" class="text-sm links cursor-pointer">adicionar
                                                        nova categoria</a>
                                            </div>

                                            <div class="hidden" id="campoCategoria">
                                                <label style="color: var(--fourth);" for="novaCategoria"
                                                    class="block text-sm font-semibold text-gray-600 mb-2">Nova
                                                    Categoria </label>
                                                <input style="color: var(--fifth);" type="text" id="novaCategoria"
                                                    name="novaCategoria"
                                        ...
                                        <div class="mb-4 grid grid-cols-2 gap-4">
                                            <div>
                                                <label style="color: var(--fourth);" for="marca"
                                                    class="block text-sm font-semibold text-gray-600 mb-2">Marca <span
                                                        class="text-red-400">*</span></label>
                                                <input style="color: var(--fifth);" type="text" id="marca" name="marca"
                                                    required
                                                    class="w-full px-3 py-2 border border-purple-600 rounded-lg focus:outline-none focus:border-yellow-500">
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            <label style="color: var(--fourth);" for="descricao"
                                                class="block text-sm font-semibold text-gray-600 mb-2">Descrição</label>
                                            <textarea style="color: var(--fifth);" id="descricao" name="descricao"
                                                rows="4"
                                        ...
                                        <div class="mb-4  rounded-lg">
                                            <label style="color: var(--fourth);" for="image"
                                                class="block text-sm font-semibold text-gray-600 mb-2">Imagem</label>
                                            <div style="color: var(--fourth);" id="dropzone"
                                                class="p-4  bg-white border border-purple-600 rounded-lg cursor-pointer gap-4 flex justify-center items-center dropzone">
                                                <svg width="30" height="30" viewBox="0 0 18 18" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#F440C7" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                            ...
                                            <input style="display: none;" type="file" id="image" name="image"
                                                accept="image/*">
                                            <div style="color: var(--third);" id="file-name"
                                                class="text-gray-600 text-sm mt-2"></div>
                                        </div>

                                        <button type="submit"
                                            class="text-white py-2 px-4 rounded-lg buttons w-full">Cadastrar
                                            Brinquedo</button>
                                    </form>
