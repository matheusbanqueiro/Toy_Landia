...
<head>
    ...
    <title>Brinquedo | Toylandia</title>
</head>
...
<body style="background-color: var(--complement1);" >
   ...
   <div class="container mx-auto mt-8 mb-8">
    <div class="flex justify-center items-center">
        ...
        <div class="flex-col">
	        <!-- <div class="inline-block mb-10">
			    <div style="background-color: var(--primary);" class="flex gap-2 p-2 items-center rounded-r-lg">
			        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			            <path id="Icon" d="M9.04907 2.92705C9.34842 2.00574 10.6518 2.00574 10.9512 2.92705L12.0207 6.21885C12.1546 6.63087 12.5386 6.90983 12.9718 6.90983H16.433C17.4017 6.90983 17.8045 8.14945 17.0208 8.71885L14.2206 10.7533C13.8701 11.0079 13.7235 11.4593 13.8573 11.8713L14.9269 15.1631C15.2263 16.0844 14.1718 16.8506 13.3881 16.2812L10.5879 14.2467C10.2374 13.9921 9.76282 13.9921 9.41234 14.2467L6.61217 16.2812C5.82845 16.8506 4.77397 16.0844 5.07333 15.1631L6.1429 11.8713C6.27677 11.4593 6.13011 11.0079 5.77962 10.7533L2.97945 8.71885C2.19574 8.14945 2.59852 6.90983 3.56724 6.90983H7.02844C7.46167 6.90983 7.84562 6.63087 7.9795 6.21885L9.04907 2.92705Z" fill="#510087" />
			        </svg>
			        <p style="color: var(--third);" class="font-semibold text-sm">Qualidade</p>
			    </div>
			</div> -->
        ...
        <table class="min-w-full divide-y divide-gray-100">
            <tbody style="background-color: var(--third);"  class="bg-white divide-y divide-gray-100">
                ...
                <tr>
                    ...
                    <td id="codigoBrinquedo" class="px-6 py-4 text-white"
                           data-codigo="<%= brinquedo.getCodigo() %>">
                    </td>
                </tr>
            </tbody>
        </table>
	...
	<script src="js/codFormate.js"></script>
