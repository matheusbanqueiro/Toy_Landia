					...
					<body style="background-color: var(--complement1);">
						<nav style="background-color: var(--complement1);"
							...
							<div>
								<ul class="flex space-x-6">
									...
									<li><a href="#destaques" class="nav-link font-semibold links">Destaques</a></li>
						...
						<div class="carousel-container">
							<div class="carousel justify-center flex mt-8 flex-col">
								<img src="imgs/image1.png" alt="banner1"
									class="carousel-image shadow-1xl rounded-xl object-cover object-center mx-auto">
								<img src="imgs/image2.png" alt="banner2"
									class="carousel-image shadow-1xl rounded-xl object-cover object-center mx-auto">
								<img src="imgs/image3.png" alt="banner3"
									class="carousel-image shadow-1xl rounded-xl object-cover object-center mx-auto">
							</div>
						</div>
						...
						<section class="container mx-auto mt-10 mb-10">
							<div style="color: var(--third);" class="text-2xl font-semibold text-center mb-10">
								Categorias Principais</div>
							...
							<div class="w-full overflow-x-auto scroll-none  ">
								<div class="w-auto flex gap-x-4 ">
									<% BrinquedoDAO dao=new BrinquedoDAO(); List<Brinquedo> brinquedosList =
										...
										%>
										<div style="background-color: var(--fourth); min-width: 250px;"
											class="w-64 p-3 border rounded-2xl">
